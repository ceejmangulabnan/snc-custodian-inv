...
const { data: statsResponse, refresh: statsRefresh } = await useAsyncData(
    'fetchCustodianTransactionsStats',
...
async function onIssueSubmitted() {
    await Promise.all([refresh(), statsRefresh()])
}
